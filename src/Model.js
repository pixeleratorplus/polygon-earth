...
export default function Model(props) {
  ...
  // This holds the hovered state
  const [hovered, set] = useState(false)
  // When it changes we set the body cursor accordingly
  useEffect(() => void (document.body.style.cursor = hovered ? 'pointer' : 'auto'), [hovered])
  return (
    <group ref={group} {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0.05]} scale={100}>
        <mesh castShadow receiveShadow geometry={nodes['URF-Height_Lampd_Ice_0'].geometry} material={materials.Lampd_Ice} />
        <mesh
        ...
        <mesh
          ...
          material-color={hovered ? 'lightgreen' : 'lime'}>
